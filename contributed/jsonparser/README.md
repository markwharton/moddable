...
\* Special _lookahead_ feature (node.next) for added convenience, as illustrated in the [matcher](./examples/matcher/main.js) example.
...
> **Note**: Certain transformations within the tree may require aggregating information in a parent node prior to updating the data. Refer to [matcher](./examples/matcher/main.js) for a concrete example of how this approach can be implemented.
