...
!IF "$(XSBUG_LOG)"=="1"
!IF "$(XSBUG_HOST)"=="localhost"
START_COMMAND = cmd /c "set "XSBUG_LOG_PORT=$(XSBUG_LOG_PORT)" && set "XSBUG_PORT=$(XSBUG_PORT)" && set "XSBUG_HOST=$(XSBUG_HOST)" && set "XSBUG_PROJECT=$(MAIN_DIR)" && $(MODDABLE)\build\bin\win\release\xsdb start /B $(SIMULATOR) $(SIMULATORS) $(BIN_DIR)\mc.dll"
!ELSE
